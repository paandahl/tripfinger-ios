...
JNI_OnLoad(JavaVM * jvm, void *)
{
    ...
    g_mapObjectClazz = jni::GetGlobalClassRef(env, "com/tripfinger/map/data/MapObject");
    g_bookmarkClazz = jni::GetGlobalClassRef(env, "com/tripfinger/map/data/Bookmark");
...
namespace jni
{
    ...
    {
        jclass klass = env->FindClass("com/tripfinger/map/data/ParcelablePointD");
        ASSERT ( klass, () );
