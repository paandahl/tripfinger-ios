...
#import "TFRCTNavItemManager.h"

#import "RCTConvert.h"
#import "TFRCTNavItem.h"

@implementation TFRCTNavItemManager

RCT_EXPORT_MODULE()

- (UIView *)view
{
  return [TFRCTNavItem new];
}
...
RCT_CUSTOM_VIEW_PROPERTY(rightButtonActions, NSArray<NSDictionary>, TFRCTNavItem)
{
  view.rightButtonActions = json;
}
