...
//  
//  var initialPoi: SimplePOI?
//  
//  init(session: Session, initialPoi: SimplePOI? = nil) {
//    self.session = session
//    self.annotationService = AnnotationService()
//    self.initialPoi = initialPoi
...
////    positionButton.addTarget(mapView, action: "goToPosition", forControlEvents: .TouchUpInside)
...
////    
////    if let initialPoi = initialPoi {
////      selectedSearchResult(initialPoi, failure: {}, stopSpinner: {})
////    }
//  }
//  
...
////    positionView.transform = CGAffineTransformMakeRotation(SKMapView.degreesToRadians(heading))
////    positionView2.transform = CGAffineTransformMakeRotation(SKMapView.degreesToRadians(heading))
