...
JNI_OnLoad(JavaVM * jvm, void *)
{
    ...
    g_mapObjectClazz = jni::GetGlobalClassRef(env, "com/tripfinger/androidcomponent2/data/MapObject");
    g_bookmarkClazz = jni::GetGlobalClassRef(env, "com/tripfinger/androidcomponent2/data/Bookmark");
...
namespace jni
{
    ...
    {
        jclass klass = env->FindClass("com/tripfinger/androidcomponent2/data/ParcelablePointD");
        ASSERT ( klass, () );
