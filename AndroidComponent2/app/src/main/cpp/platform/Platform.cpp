...
string Platform::GetMemoryInfo() const
{
    ...
    static shared_ptr<jobject> classMemLogging = jni::make_global_ref(env->FindClass("com/tripfinger/androidcomponent2/util/log/MemLogging"));
...
Platform::EConnectionType Platform::ConnectionStatus()
{
    ...
    static shared_ptr<jobject> clazzConnectionState = jni::make_global_ref(env->FindClass("com/tripfinger/androidcomponent2/util/ConnectionState"));
