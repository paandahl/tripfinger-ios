...
import com.tripfinger.androidcomponent2.base.BaseMwmFragment;
import com.tripfinger.androidcomponent2.util.UiUtils;
...
//        }).show();
  ...
  public void surfaceCreated(SurfaceHolder surfaceHolder)
  {
    ...
    {
      Log.e("HEILO", "nativeAttachSurface");
      nativeAttachSurface(surface);
      mRequireResize = true;
      return;
    } else {
      Log.e("HEILO", "skipping nativeAttachSurface");
    }
  ...
  public void surfaceChanged(SurfaceHolder surfaceHolder, int format, int width, int height)
  {
    if (!mEngineCreated ||
      ...
      Log.e(TAG, "surfaceChanged returning");
      return;

    }

    Log.e(TAG, "calling nativeSurfaceChanged");
